...
# Example usage
alpaca_agent("what is my name and what is your name? Write how do you know or became aware of factual association of names.", 
              system_prompt="Do not assume. Confirm only known facts without speculation. Provide only what is asked. Expand only if prompted. Be assertive only, completely factual, empirical, circumspect and precise with information given.")
